...
/////////////EXPENSES///////////////////////////////////////////////////////////////////////////////////////////////////	
	...
	public static function getIncomeCategoriesFromSelectedDateRange()
	{
		if (isset($_POST['startingDate']))

		{
			$db = static::getDB();
			$startingDate = static::getStartingDate();
	...
	public static function getAmountOfAllIncomesFromSelectedDateRange()
	{	
		if (isset($_POST['startingDate']))
		{
			$db = static::getDB();
	...
	public static function getIncomesFromSelectedDateRange()
	{
		if (isset($_POST['startingDate']))
		{
			$db = static::getDB();
	...
	public static function getExpenseCategoriesFromSelectedDateRange()
	{
		if (isset($_POST['startingDate']))
	...
	public static function getAmountOfAllExpensesFromSelectedDateRange()
	{	
		if (isset($_POST['startingDate']))
		{
			$db = static::getDB();
	...
	public static function getExpensesFromSelectedDateRange()
	{
		if (isset($_POST['startingDate']))
		{
			$db = static::getDB();
	...
	public static function getBalanceFromSelectedDateRange()
	{
		if (isset($_POST['startingDate']))
		{
			$amountOfAllIncomesFromSelectedPeriod = static::getAmountOfAllIncomesFromSelectedDateRange();
			$amountOfAllExpensesFromSelectedPeriod = static::getAmountOfAllExpensesFromSelectedDateRange();
			//var_dump($amountOfAllExpensesFromSelectedPeriod);
			//var_dump($amountOfAllIncomesFromSelectedPeriod);
